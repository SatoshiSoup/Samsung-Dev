...
import com.satoshisoup.storjlibmodule.models.FileDeleteModel;
...
import static com.satoshisoup.storjlibmodule.StorjLibModule.STORJ_URL;
import static com.satoshisoup.storjlibmodule.services.ServiceModule.GET_BUCKETS;
import static com.satoshisoup.storjlibmodule.services.ServiceModule.GET_FILES;
import static com.satoshisoup.storjlibmodule.services.ServiceModule.BUCKET_CREATED;
import static com.satoshisoup.storjlibmodule.services.ServiceModule.BUCKET_DELETED;
import static com.satoshisoup.storjlibmodule.services.ServiceModule.FILE_DELETED;
...
public class FetchService extends BaseReactService {
    ...
    public final static String SERVICE_NAME = "com.satoshisoup.storjlibmodule.services.FetchService";
...
//
//                try {
//                    StorjAndroid.getInstance(mContext, STORJ_URL).getBuckets(new GetBucketsCallback() {
//                        @Override
//                        public void onBucketsReceived(Bucket[] buckets) {
//                            Log.d("onBucketsReceived",buckets.toString());
//
//                        }
//
//                        @Override
//                        public void onError(int code, String message) {
//                            Log.d("onBucketsReceived error",message);
//
//                        }
//                    });
...
//        new Handler().post(runnable);
    ...
    private void createBucket(final String bucketName) {
        getInstance().createBucket(bucketName.toLowerCase().trim(), new CreateBucketCallback() {
            @Override
            public void onBucketCreated(Bucket bucket) {
                Log.d("bucket created", bucket.getName());
            ...
            public void onError(String bucketName, int code, String message) {
                Log.d("bucket created error", message);
                if (mContext == null) {
                    return;
                }
