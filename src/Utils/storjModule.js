...
const StorjLib = (() => {
    ...
    class StorjModule {
         ...
         * @returns {Promise<boolean>}
         */
        async verifyKeys(apiKey, encryptionKey) {            
            let response = await storjLib.verifyKeys(apiKey, encryptionKey);
         ...
         * @returns {Promise<boolean>}
         */
        async importKeys(apiKey, encryptionKey, passcode) {            
            let response = await storjLib.importKeys(apiKey, encryptionKey, passcode);
